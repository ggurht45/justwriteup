...
\department{\href{http://www.cs.ox.ac.uk/ Department of Computer Science}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
{\large \today}\\[4cm] % Date
\includegraphics{Figures/universityLogo.JPG} % University/department logo - uncomment to place it
