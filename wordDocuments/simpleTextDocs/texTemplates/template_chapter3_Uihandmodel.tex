...
describe what is meant by observable. look at the good paragraph for inspiration. --done

connect javafx to observable.--done

 and explain javafx.concurrent.



(talk bout javafx concurrent package--done. lead into observable--done and util concurrency package. )
